...
const s = {
  card: { background: "#fff", borderRadius: 24, padding: "clamp(20px, 6vw, 28px) clamp(14px, 5vw, 24px)", boxShadow: "0 8px 40px rgba(79,70,229,0.10)", border: "1px solid rgba(99,102,241,0.10)", width: "100%", maxWidth: 520, margin: "0 auto", boxSizing: "border-box" },
